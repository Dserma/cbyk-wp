	...
	require_once( ABSPATH . WPINC . '/default-widgets.php' );
        ...
        function create_post_type_produto() {
            $labels = array(
                ...
                'all_items' => __('Lista de Produtos'),
